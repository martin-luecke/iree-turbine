  ...
  stream.executable private @gemm {
    ...
    builtin.module {
      func.func @gemm(%_A: !stream.binding, %_B: !stream.binding, %_C: !stream.binding) attributes {translation_info = #translation} {
        ...
        // Where 0-63 is first buffer, 64-127 is second buffer
        %A_shared = memref.alloc() : memref<128x68xf16, #gpu.address_space<workgroup>>
        %B_shared = memref.alloc() : memref<128x68xf16, #gpu.address_space<workgroup>>
        ...
        vector.store %11, %A_shared[%7, %10] : memref<128x68xf16, #gpu.address_space<workgroup>>, vector<8xf16>
        vector.store %15, %A_shared[%13, %10] : memref<128x68xf16, #gpu.address_space<workgroup>>, vector<8xf16>
        vector.store %19, %B_shared[%7, %10] : memref<128x68xf16, #gpu.address_space<workgroup>>, vector<8xf16>
        vector.store %21, %B_shared[%13, %10] : memref<128x68xf16, #gpu.address_space<workgroup>>, vector<8xf16>
        amdgpu.lds_barrier
        ...
        %31 = vector.load %A_shared[%26, %30] : memref<128x68xf16, #gpu.address_space<workgroup>>, vector<4xf16>
        %32 = arith.addi %29, %c48 overflow<nsw, nuw> : index
        %33 = vector.load %A_shared[%26, %32] : memref<128x68xf16, #gpu.address_space<workgroup>>, vector<4xf16>
        ...
        %37 = vector.load %B_shared[%36, %30] : memref<128x68xf16, #gpu.address_space<workgroup>>, vector<4xf16>
        %38 = vector.load %B_shared[%36, %32] : memref<128x68xf16, #gpu.address_space<workgroup>>, vector<4xf16>
        %39 = vector.load %A_shared[%26, %29] : memref<128x68xf16, #gpu.address_space<workgroup>>, vector<4xf16>
        %40 = arith.addi %29, %c16 overflow<nsw, nuw> : index
        %41 = vector.load %A_shared[%26, %40] : memref<128x68xf16, #gpu.address_space<workgroup>>, vector<4xf16>
        %42 = vector.load %B_shared[%36, %29] : memref<128x68xf16, #gpu.address_space<workgroup>>, vector<4xf16>
        %43 = vector.load %B_shared[%36, %40] : memref<128x68xf16, #gpu.address_space<workgroup>>, vector<4xf16>
        %44 = vector.load %B_shared[%35, %29] : memref<128x68xf16, #gpu.address_space<workgroup>>, vector<4xf16>
        %45 = vector.load %B_shared[%35, %40] : memref<128x68xf16, #gpu.address_space<workgroup>>, vector<4xf16>
        %46 = vector.load %B_shared[%35, %30] : memref<128x68xf16, #gpu.address_space<workgroup>>, vector<4xf16>
        %47 = vector.load %B_shared[%35, %32] : memref<128x68xf16, #gpu.address_space<workgroup>>, vector<4xf16>
        ...
        %54 = vector.load %A_shared[%25, %29] : memref<128x68xf16, #gpu.address_space<workgroup>>, vector<4xf16>
        %55 = vector.load %A_shared[%25, %40] : memref<128x68xf16, #gpu.address_space<workgroup>>, vector<4xf16>
        %56 = vector.load %A_shared[%25, %30] : memref<128x68xf16, #gpu.address_space<workgroup>>, vector<4xf16>
        %57 = vector.load %A_shared[%25, %32] : memref<128x68xf16, #gpu.address_space<workgroup>>, vector<4xf16>
        ...
        amdgpu.lds_barrier
        vector.store %50, %A_shared[%7, %10] : memref<128x68xf16, #gpu.address_space<workgroup>>, vector<8xf16>
        vector.store %51, %A_shared[%13, %10] : memref<128x68xf16, #gpu.address_space<workgroup>>, vector<8xf16>
        vector.store %52, %B_shared[%7, %10] : memref<128x68xf16, #gpu.address_space<workgroup>>, vector<8xf16>
        vector.store %53, %B_shared[%13, %10] : memref<128x68xf16, #gpu.address_space<workgroup>>, vector<8xf16>
        ...
        amdgpu.lds_barrier
        %68 = vector.load %A_shared[%26, %30] : memref<128x68xf16, #gpu.address_space<workgroup>>, vector<4xf16>
        %69 = vector.load %A_shared[%26, %32] : memref<128x68xf16, #gpu.address_space<workgroup>>, vector<4xf16>
        %70 = vector.load %B_shared[%36, %30] : memref<128x68xf16, #gpu.address_space<workgroup>>, vector<4xf16>
        %71 = vector.load %B_shared[%36, %32] : memref<128x68xf16, #gpu.address_space<workgroup>>, vector<4xf16>
        ...
        %75 = vector.load %A_shared[%26, %29] : memref<128x68xf16, #gpu.address_space<workgroup>>, vector<4xf16>
        %76 = vector.load %A_shared[%26, %40] : memref<128x68xf16, #gpu.address_space<workgroup>>, vector<4xf16>
        %77 = vector.load %B_shared[%36, %29] : memref<128x68xf16, #gpu.address_space<workgroup>>, vector<4xf16>
        %78 = vector.load %B_shared[%36, %40] : memref<128x68xf16, #gpu.address_space<workgroup>>, vector<4xf16>
        %79:16 = scf.for %arg3 = %c0 to %c18 step %c1 iter_args(%arg4 = %74, %arg5 = %67, %arg6 = %57, %arg7 = %75, %arg8 = %76, %arg9 = %68, %arg10 = %69, %arg11 = %47, %arg12 = %77, %arg13 = %78, %arg14 = %70, %arg15 = %38, %arg16 = %71, %arg17 = %72, %arg18 = %73, %buffer_offset = %c0) -> (vector<4xf32>, vector<4xf32>, vector<4xf16>, vector<4xf16>, vector<4xf16>, vector<4xf16>, vector<4xf16>, vector<4xf16>, vector<4xf16>, vector<4xf16>, vector<4xf16>, vector<4xf16>, vector<4xf16>, vector<4xf32>, vector<4xf32>, index) {
          ...
          %current_base = arith.addi %c0, %buffer_offset : index  // One VGPR
          %next_base = arith.xori %buffer_offset, %c64 : index    // One VGPR
          ...
          %load_idx_35 = arith.addi %35, %current_base : index
          %137 = vector.load %B_shared[%load_idx_35, %29] : memref<128x68xf16, #gpu.address_space<workgroup>>, vector<4xf16>
          %138 = vector.load %B_shared[%load_idx_35, %40] : memref<128x68xf16, #gpu.address_space<workgroup>>, vector<4xf16>
          %139 = vector.load %B_shared[%load_idx_35, %30] : memref<128x68xf16, #gpu.address_space<workgroup>>, vector<4xf16>
          %140 = vector.load %B_shared[%load_idx_35, %32] : memref<128x68xf16, #gpu.address_space<workgroup>>, vector<4xf16>
          ...
          %load_idx_25 = arith.addi %25, %current_base : index
          %149 = vector.load %A_shared[%load_idx_25, %29] : memref<128x68xf16, #gpu.address_space<workgroup>>, vector<4xf16>
          %150 = vector.load %A_shared[%load_idx_25, %40] : memref<128x68xf16, #gpu.address_space<workgroup>>, vector<4xf16>
          %151 = vector.load %A_shared[%load_idx_25, %30] : memref<128x68xf16, #gpu.address_space<workgroup>>, vector<4xf16>
          %152 = vector.load %A_shared[%load_idx_25, %32] : memref<128x68xf16, #gpu.address_space<workgroup>>, vector<4xf16>
          ...
          // amdgpu.lds_barrier
          // %next_offset = arith.xori %buffer_offset, %c64 : index
          %new7 = arith.addi %7, %next_base : index
          %new13 = arith.addi %13, %next_base : index
          vector.store %145, %A_shared[%new7, %10] : memref<128x68xf16, #gpu.address_space<workgroup>>, vector<8xf16>
          vector.store %146, %A_shared[%new13, %10] : memref<128x68xf16, #gpu.address_space<workgroup>>, vector<8xf16>
          vector.store %147, %B_shared[%new7, %10] : memref<128x68xf16, #gpu.address_space<workgroup>>, vector<8xf16>
          vector.store %148, %B_shared[%new13, %10] : memref<128x68xf16, #gpu.address_space<workgroup>>, vector<8xf16>
          ...
          amdgpu.lds_barrier
          %new26 = arith.addi %26, %next_base : index
          %new36 = arith.addi %36, %next_base : index
          %163 = vector.load %A_shared[%new26, %30] : memref<128x68xf16, #gpu.address_space<workgroup>>, vector<4xf16>
          %164 = vector.load %A_shared[%new26, %32] : memref<128x68xf16, #gpu.address_space<workgroup>>, vector<4xf16>
          %165 = vector.load %B_shared[%new36, %30] : memref<128x68xf16, #gpu.address_space<workgroup>>, vector<4xf16>
          %166 = vector.load %B_shared[%new36, %32] : memref<128x68xf16, #gpu.address_space<workgroup>>, vector<4xf16>
          ...
          %170 = vector.load %A_shared[%new26, %29] : memref<128x68xf16, #gpu.address_space<workgroup>>, vector<4xf16>
          %171 = vector.load %A_shared[%new26, %40] : memref<128x68xf16, #gpu.address_space<workgroup>>, vector<4xf16>
          %172 = vector.load %B_shared[%new36, %29] : memref<128x68xf16, #gpu.address_space<workgroup>>, vector<4xf16>
          %173 = vector.load %B_shared[%new36, %40] : memref<128x68xf16, #gpu.address_space<workgroup>>, vector<4xf16>
          scf.yield %169, %162, %152, %170, %171, %163, %164, %140, %172, %173, %165, %arg16, %166, %167, %168, %next_base : vector<4xf32>, vector<4xf32>, vector<4xf16>, vector<4xf16>, vector<4xf16>, vector<4xf16>, vector<4xf16>, vector<4xf16>, vector<4xf16>, vector<4xf16>, vector<4xf16>, vector<4xf16>, vector<4xf16>, vector<4xf32>, vector<4xf32>, index
        }
        ...
        %82 = vector.load %B_shared[%35, %29] : memref<128x68xf16, #gpu.address_space<workgroup>>, vector<4xf16>
        %83 = vector.load %B_shared[%35, %40] : memref<128x68xf16, #gpu.address_space<workgroup>>, vector<4xf16>
        %84 = vector.load %B_shared[%35, %30] : memref<128x68xf16, #gpu.address_space<workgroup>>, vector<4xf16>
        %85 = vector.load %B_shared[%35, %32] : memref<128x68xf16, #gpu.address_space<workgroup>>, vector<4xf16>
        %86 = amdgpu.mfma %79#3 * %79#8 + %79#1 {blocks = 1 : i32, k = 16 : i32, m = 16 : i32, n = 16 : i32} blgp =  none : vector<4xf16>, vector<4xf16>, vector<4xf32>
        %87 = vector.load %A_shared[%25, %29] : memref<128x68xf16, #gpu.address_space<workgroup>>, vector<4xf16>
        %88 = vector.load %A_shared[%25, %40] : memref<128x68xf16, #gpu.address_space<workgroup>>, vector<4xf16>
        %89 = vector.load %A_shared[%25, %30] : memref<128x68xf16, #gpu.address_space<workgroup>>, vector<4xf16>
        %90 = vector.load %A_shared[%25, %32] : memref<128x68xf16, #gpu.address_space<workgroup>>, vector<4xf16>
