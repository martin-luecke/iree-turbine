  ...
  stream.executable private @gemm {
    ...
    builtin.module {
      func.func @gemm(%A1: !stream.binding, %B1: !stream.binding, %C: !stream.binding) attributes {translation_info = #translation} {
        ...
        %A_shared_1 = memref.alloc() : memref<64x68xf16, #gpu.address_space<workgroup>> // changed
        %B_shared = memref.alloc() : memref<64x68xf16, #gpu.address_space<workgroup>>
        %B_shared_1 = memref.alloc() : memref<64x68xf16, #gpu.address_space<workgroup>> // changed
        ...
        %79:19 = scf.for %arg3 = %c0 to %c18 step %c1 iter_args(%arg4 = %74, %arg5 = %67, %arg6 = %57, %arg7 = %75, %arg8 = %76, %arg9 = %68, %arg10 = %69, %arg11 = %47, %arg12 = %77, %arg13 = %78, %arg14 = %70, %arg15 = %38, %arg16 = %71, %arg17 = %72, %arg18 = %73, %A_shared_compute = %A_shared, %A_shared_next = %A_shared_1, %B_shared_compute = %B_shared, %B_shared_next = %B_shared_1) -> (vector<4xf32>, vector<4xf32>, vector<4xf16>, vector<4xf16>, vector<4xf16>, vector<4xf16>, vector<4xf16>, vector<4xf16>, vector<4xf16>, vector<4xf16>, vector<4xf16>, vector<4xf16>, vector<4xf16>, vector<4xf32>, vector<4xf32>, memref<64x68xf16, #gpu.address_space<workgroup>>, memref<64x68xf16, #gpu.address_space<workgroup>>, memref<64x68xf16, #gpu.address_space<workgroup>>, memref<64x68xf16, #gpu.address_space<workgroup>>) { // changed
          ...
          %137 = vector.load %B_shared_compute[%35, %29] : memref<64x68xf16, #gpu.address_space<workgroup>>, vector<4xf16> // changed
          %138 = vector.load %B_shared_compute[%35, %40] : memref<64x68xf16, #gpu.address_space<workgroup>>, vector<4xf16> // changed
          %139 = vector.load %B_shared_compute[%35, %30] : memref<64x68xf16, #gpu.address_space<workgroup>>, vector<4xf16> // changed
          %140 = vector.load %B_shared_compute[%35, %32] : memref<64x68xf16, #gpu.address_space<workgroup>>, vector<4xf16> // changed
          ...
          %149 = vector.load %A_shared_compute[%25, %29] : memref<64x68xf16, #gpu.address_space<workgroup>>, vector<4xf16> // changed
          %150 = vector.load %A_shared_compute[%25, %40] : memref<64x68xf16, #gpu.address_space<workgroup>>, vector<4xf16> // changed
          %151 = vector.load %A_shared_compute[%25, %30] : memref<64x68xf16, #gpu.address_space<workgroup>>, vector<4xf16> // changed
          %152 = vector.load %A_shared_compute[%25, %32] : memref<64x68xf16, #gpu.address_space<workgroup>>, vector<4xf16> // changed
          ...
          //amdgpu.lds_barrier // changed
          vector.store %145, %A_shared_next[%7, %10] : memref<64x68xf16, #gpu.address_space<workgroup>>, vector<8xf16> // changed
          vector.store %146, %A_shared_next[%13, %10] : memref<64x68xf16, #gpu.address_space<workgroup>>, vector<8xf16> // changed
          vector.store %147, %B_shared_next[%7, %10] : memref<64x68xf16, #gpu.address_space<workgroup>>, vector<8xf16> // changed
          vector.store %148, %B_shared_next[%13, %10] : memref<64x68xf16, #gpu.address_space<workgroup>>, vector<8xf16> // changed
          ...
          amdgpu.lds_barrier
          %163 = vector.load %A_shared_next[%26, %30] : memref<64x68xf16, #gpu.address_space<workgroup>>, vector<4xf16> // changed
          %164 = vector.load %A_shared_next[%26, %32] : memref<64x68xf16, #gpu.address_space<workgroup>>, vector<4xf16> // changed
          %165 = vector.load %B_shared_next[%36, %30] : memref<64x68xf16, #gpu.address_space<workgroup>>, vector<4xf16> // changed
          %166 = vector.load %B_shared_next[%36, %32] : memref<64x68xf16, #gpu.address_space<workgroup>>, vector<4xf16> // changed
          %170 = vector.load %A_shared_next[%26, %29] : memref<64x68xf16, #gpu.address_space<workgroup>>, vector<4xf16> // changed
          %171 = vector.load %A_shared_next[%26, %40] : memref<64x68xf16, #gpu.address_space<workgroup>>, vector<4xf16> // changed
          %172 = vector.load %B_shared_next[%36, %29] : memref<64x68xf16, #gpu.address_space<workgroup>>, vector<4xf16> // changed
          %173 = vector.load %B_shared_next[%36, %40] : memref<64x68xf16, #gpu.address_space<workgroup>>, vector<4xf16> // changed
          scf.yield %169, %162, %152, %170, %171, %163, %164, %140, %172, %173, %165, %arg16, %166, %167, %168, %A_shared_next, %A_shared_compute, %B_shared_next, %B_shared_compute : vector<4xf32>, vector<4xf32>, vector<4xf16>, vector<4xf16>, vector<4xf16>, vector<4xf16>, vector<4xf16>, vector<4xf16>, vector<4xf16>, vector<4xf16>, vector<4xf16>, vector<4xf16>, vector<4xf16>, vector<4xf32>, vector<4xf32>, memref<64x68xf16, #gpu.address_space<workgroup>>, memref<64x68xf16, #gpu.address_space<workgroup>>, memref<64x68xf16, #gpu.address_space<workgroup>>, memref<64x68xf16, #gpu.address_space<workgroup>> // changed
        }
