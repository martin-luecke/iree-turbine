    ...
    builtin.module {
      func.func @gemm(%_A: !stream.binding, %_B: !stream.binding, %_C: !stream.binding) attributes {translation_info = #translation} {
        ...
        %79:16 = scf.for %arg3 = %c0 to %c18 step %c1 iter_args(%arg4 = %74, %arg5 = %67, %arg6 = %57, %arg7 = %75, %arg8 = %76, %arg9 = %68, %arg10 = %69, %arg11 = %47, %arg12 = %77, %arg13 = %78, %arg14 = %70, %arg15 = %38, %arg16 = %71, %arg17 = %72, %arg18 = %73, %buffer_offset = %c0) -> (vector<4xf32>, vector<4xf32>, vector<4xf16>, vector<4xf16>, vector<4xf16>, vector<4xf16>, vector<4xf16>, vector<4xf16>, vector<4xf16>, vector<4xf16>, vector<4xf16>, vector<4xf16>, vector<4xf16>, vector<4xf32>, vector<4xf32>, index) {
          ...
          %load_idx_35 = arith.addi %35, %buffer_offset : index
          ...
          %load_idx_25 = arith.addi %25, %buffer_offset : index
          ...
          %new7 = arith.addi %7, %next_offset : index
          %new13 = arith.addi %13, %next_offset : index
          ...
          amdgpu.lds_barrier
          %new26 = arith.addi %26, %next_offset : index
          %new36 = arith.addi %36, %next_offset : index
          ...
          scf.yield %169, %162, %152, %170, %171, %163, %164, %140, %172, %173, %165, %arg16, %166, %167, %168, %next_offset : vector<4xf32>, vector<4xf32>, vector<4xf16>, vector<4xf16>, vector<4xf16>, vector<4xf16>, vector<4xf16>, vector<4xf16>, vector<4xf16>, vector<4xf16>, vector<4xf16>, vector<4xf16>, vector<4xf16>, vector<4xf32>, vector<4xf32>, index
        }
